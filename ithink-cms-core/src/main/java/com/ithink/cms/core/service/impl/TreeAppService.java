...
import com.ithink.cms.core.utils.ModelMapperUtil;
import com.ithink.cms.core.domin.TreeEntityBase;
import com.ithink.cms.core.domin.TreeEntityDto;
import com.ithink.cms.core.repository.TreeAppRepository;
...
extends CrudAppServiceBase<TRepository,TEntityBase,TEntityDto,TKey> {
    ...
    protected TEntityBase map(TEntityDto dto){
        ...
        TEntityBase tEntityBase = ModelMapperUtil.map(dto, getEntityType());
